      ...
      <ul class="nav navbar-nav">
        ...
        <li>
          ...
          <?php 
            if ($_SESSION['ProjectType'] =='1') 
            {
                echo '<li class="active"><a href="concept2.php"><span class="glyphicon glyphicon-dashboard"></span> Graph 2</a></li>';
                echo '<li><a href="concept3.php"><span class="glyphicon glyphicon-dashboard"></span> Graph 3</a></li>';
            }
          ?>
        <li>
...
<script src="conv2.min.js"></script>
