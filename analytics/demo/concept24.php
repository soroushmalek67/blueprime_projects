<?php
  session_start();
    ...
    if ($_SESSION['ProjectType'] =='1') 
      header("Location: concept4.php");
    else if ($_SESSION['ProjectType'] =='2') 
      header("Location: concept10.php");
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Firmogram - Capabilities</title>
...
<body>
  ...
  <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    ...
    <br/><br/><br/>
          <div style="width:400px;margin-left: auto;margin-right: auto;">
            <a href="treemap.php" role="button" class="btn btn-info">Tree Map</a>    
            <a href="pack.php" role="button" class="btn btn-success">Overview</a>    
            <a id="export" class="btn btn-success">Export</a>     
          </div>  
    ...
    <div class="wrap">
      ...
      <br/>
        ...
        <script src="conv24.min.js"></script>
      </div><!-- #main -->
      <div id="footer">
  ...
  <canvas width="950" height="800" style="display:none"></canvas>
...
d3.select("#export").on("click", function(){
  var html = d3.select("#graph").select("svg")
        .attr("version", 1.1)
