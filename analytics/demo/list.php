    ...
    <div class="container">
      ...
      <div class="jumbotron1">
        <div class="bs-docs-example">
            <form class="form-horizontal" role="form" action="listActions.php" method="post">
			...
			echo "<div class='form-group'> \n";
                ...
                <?php
                  ...
                  if ($end>$total)
                    $end = $total;
                  if ($page>1) 
                    echo "<li class='previous'><a href='list.php?page=$pageN1'>Previous $pageCount</a></li>";
                  else
                  ...
                  if ($page*$pageCount<$total)
                    echo "<li class='next'><a href='list.php?page=$pageP1'>Next $pageCount</a></li>";
                  else
              ...
              <tbody>
                ...
                else
                {
                  ...
                  while($row = mysqli_fetch_array($result))
                  {
                    ...
                    echo "<td><a href='#myModal' data-capabilities='" . $row['CompanyCapabilities'] . "' data-contactname='" . $row['ContactName'] . "' data-contacttitle='" . $row['ContactTitle'] . "' data-contactemail='" . $row['ContactEmail'] . "' data-facebook='" . $row['FacebookURL'] . "' data-twitter='" . $row['TwitterURL'] . "' data-linkedin='" . $row['LinkedInURL'] . "' data-website='http://" . $row['Website'] . "' data-name='" . $row['Name'] . "' data-industry='" . $row['Sector'] . "' data-phone='" . $row['Phone'] . "' data-description='" . str_replace(">", "&gt", $row['Description']) . "' data-address='" . $row['Address'] . ", " . $row['City'] . ", " . $row['State'] . ", " . $row['PostalCode'] . ", " . $row['Country'] . "' role='button' data-toggle='modal' class='open-MyModal'>" . $row['Name'] . "</a></td>";
                    echo "<td>" . $row['City'] . "</td>";
