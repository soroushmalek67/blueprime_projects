...
include 'dbConn2.php';
$sql = "SELECT u1.ID,u1.Password,u1.ParentUserID,(SELECT COUNT(*) FROM Users u2 WHERE u2.ParentUserID=u1.ID) ViewerCount FROM Users u1 WHERE Username='".$username."' and Status=1";
