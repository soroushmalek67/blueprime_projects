...
session_start();
	...
	{
		include 'dbConn2.php';
		$sql = "INSERT INTO Users (Username,Password,Organization,CreatedDate,Status,ParentUserID) VALUES ('".$_POST['email']."','".$_POST['password']."','".$_POST['organization']."',CURDATE(),0,111)";
	...
	//	$_SESSION['Username'] = $_POST['email'];
		...
		$mail->msgHTML("Username: <i>" . $_POST['email'] . "</i><br/>Organization: <i>" . $_POST['organization'] . "</i>");
		$mail->send();
