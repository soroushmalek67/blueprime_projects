(function() {
    var a = 950, c = 800, h = c, U = 200, K = 22, S = 20, s = 8, R = 110, J = 20, o = 15, t = 10, w = 600, F = "elastic", N = "#0da4d3";
    var T, q, x, j, H, A, P;
    var L = {}, k = {};
    var i, y;
    ...
    d3.json("compdata24.php", function(X, Y) {
        T = d3.map(Y);
        q = d3.merge(T.values());
        x = {};
        A = d3.map();
    ...
    function D(Y) {
        ...
        Y.append("text").attr("font-size", 50);
