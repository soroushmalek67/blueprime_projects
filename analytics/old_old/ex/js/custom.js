...
$(function() {
    ...
    $('.loginPopupBtn').click(function(){
        $('.gn-menu-main .login-dropdown').css('display','block');
        $('body').append("<div onclick='hideLoginPopup();' class='temp-login'></div>");
    });
...
function hideLoginPopup () {
	$('.gn-menu-main .login-dropdown').css('display','none');
    $( ".temp-login" ).remove();
}

function redirectToAnalyticsSite () {
	var user = $("[name='domain']").val();
	if (user == 'demo') {
		window.location.href='http://demo.firmogram.com/'
	} else {
		window.location.href='signupNew.php'
	}
}
