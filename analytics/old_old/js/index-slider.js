...
$(document).ready(function () {
    ...
    function c() {
        ...
        function g() {
            ...
            $(".slide.previous img.fade,.slide.previous .info").fadeOut(60000, "easeInQuad", function () {
                $(".slide.next").removeClass("next").addClass("active").fadeIn(50000, "easeInOutQuad", function () {
                    $(".slide.previous").removeClass("previous").fadeOut(50000, "easeInOutQuad");
                    j()
                })
            })
        }
