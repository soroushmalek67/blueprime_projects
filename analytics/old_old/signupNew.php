            ...
            <li class="gn-trigger">
              ...
              <nav class="gn-menu-wrapper">
                <div class="gn-scroller">
                  <ul class="gn-menu">
                    <li><a href="index.php#intro"><i class="gn-icon icon-home"></i>Home</a></li>
                    <li><a href="index.php#about"><i class="gn-icon linecon-bulb"></i>About</a></li>
                    <li><a href="index.php#about-1"><i class="gn-icon linecon-star"></i>Features</a></li>
<!--                    <li><a href="#pricing"><i class="gn-icon linecon-banknote"></i>Pricing</a></li> -->
            ...
            <!-- logo -->
            <li class="logo-wrapper"><a class="logo home1" href="index.php">FIRMOGRAM</a></li>
